...
//// </copyright>
//// <summary>
////   Implements the Dark Data Metric which calculates how many records are Shadow Entities versus not. 
//// </summary>
//// --------------------------------------------------------------------------------------------------------------------
...
//{
//    public class DarkDataMetric : PercentageMetric
//    {
//        private readonly IMetricProviderResolver providerResolver;

//        public DarkDataMetric(IMetricProviderResolver providerResolver)
//        {
...
//        public override Guid Id { get; } = new Guid("{83334AE1-85A4-44AB-BB45-708ABE2DC1AA}");
