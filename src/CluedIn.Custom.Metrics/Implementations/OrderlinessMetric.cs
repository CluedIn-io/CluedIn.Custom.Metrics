...
//{
//    public class OrderlinessMetric : PercentageMetric
//    {
//        private readonly IMetricProviderResolver providerResolver;

//        public OrderlinessMetric(IMetricProviderResolver providerResolver)
//        {
...
//        public override Guid Id { get; } = new Guid("{44F41C14-E498-41BE-A9EF-718633F6C4EE}");
...
//            double cleanInputCount = parts.Count(d => d.Attributes.ContainsKey("inputSource") && EntityUserInputSources.IsUserInputSource(d.Attributes["inputSource"]));

//            double totalCounts = parts.Count();

//            double returnValue = cleanInputCount / (totalCounts / 2);
