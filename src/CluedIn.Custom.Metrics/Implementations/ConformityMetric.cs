...
//{
//    public class ConformityMetric : PercentageMetric
//    {
//        private readonly IMetricProviderResolver providerResolver;

//        public ConformityMetric(IMetricProviderResolver providerResolver)
//        {
...
//        public override Guid Id { get; } = new Guid("{13D5AE06-4EF7-4C27-BBE0-E196CFAC5CAA}");
...
//                    var connectivity = CalculateMetricValue(map);
...
//        private static double CalculateMetricValue((IEnumerable<EntityEdge> outgoingEdges, IEnumerable<EntityEdge> incomingEdges) edgesMap)
//        {
//            //How many properties have a standard of which this record abides by.

//            if (edgesMap.outgoingEdges.Any() || edgesMap.incomingEdges.Any())
//                return 1;


//            // TODO:
//            // there are industrial standard vocabs. Like phone number formats. Is standard.
