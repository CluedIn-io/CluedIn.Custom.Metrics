...
//{
//    public class UsabilityMetric : PercentageMetric
//    {
//        private readonly IMetricProviderResolver providerResolver;


//        public UsabilityMetric(IMetricProviderResolver providerResolver)
//        {
...
//        public override Guid Id { get; } = new Guid("{42140898-2490-4834-B93C-01818B6B0B27}");
...
//        {
//            //How many streams is this data used in?
...
//            double maxCount = dbContext.Streams.Count();
//            return (cc / maxCount);
//        }
